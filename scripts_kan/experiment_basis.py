...
class Experiment(object):
    ...
    def exp(self, config):
        ...
        cmd = '/home/kanwu/Research/739-wisckey/db_bench --db=/mnt/970/db_16384 --value_size=16384 --cache_size=0 --compression_ratio=1 --benchmarks=readrandom,readrandom_1 --use_existing_db=1 --db_num=6600000 --reads=200000 ' + '--threads=' + str(config['threads']) #+ ' > /dev/shm/running'
