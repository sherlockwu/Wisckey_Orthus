...
class Experiment(object):
    ...
    def exp(self, config):
        ...
        #Medium: 16KB value
        cmd = '/home/kanwu/Research/739-wisckey/db_bench --db=/mnt/970/db_16384 --value_size=16384 --cache_size=0 --compression_ratio=1 --benchmarks=ycsb --use_existing_db=1 --db_num=6600000 --reads=10000000 --frequency=' + str(config['frequency']) + ' --step=' + str(config['step']) + ' --threads=' + str(config['threads']) + ' > /dev/shm/running'
