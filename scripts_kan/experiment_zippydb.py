...
class Experiment(object):
    ...
    def exp(self, config):
        ...
        #Small: 1KB value
        #cmd = '/home/kanwu/Research/739-wisckey/db_bench --db=/mnt/970/db_1024 --value_size=1024 --write_buffer_size=134217728 --cache_size=0 --compression_ratio=1 --benchmarks=mixgraph --use_existing_db=1 --db_num=80000000 --reads=500000 ' + '--threads=' + str(config['threads']) #+ ' > /dev/shm/running'
        cmd = '/home/kanwu/Research/739-wisckey/db_bench --db=/mnt/optane/db_1024 --value_size=1024 --write_buffer_size=134217728 --cache_size=0 --compression_ratio=1 --benchmarks=mixgraph --use_existing_db=1 --db_num=80000000 --reads=500000 ' + '--threads=' + str(config['threads']) #+ ' > /dev/shm/running'
